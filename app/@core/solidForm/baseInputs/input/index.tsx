...
import { hasValidation, validateInput } from './helpers'
import styles from './styles.css'
import { IInputTextProps, IInputTextState, IInputValidationResult } from './types'

export class InputText extends PureComponent<IInputTextProps, IInputTextState> {
  public readonly state: IInputTextState = {
    value: this.props.value || '',
    isValid: false,
    isTouched: false,
    validationMessages: []
  }
  private initialState: IInputTextState

  private inputRef: React.RefObject<HTMLInputElement> = React.createRef()

  public componentDidUpdate(prevProps: IInputTextProps, prevState: IInputTextState): void {
